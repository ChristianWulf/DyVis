...
public class StaticsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StaticsPackage.DPACKAGE: {
				DPackage dPackage = (DPackage)theEObject;
				T result = caseDPackage(dPackage);
				if (result == null) result = caseIComponent(dPackage);
				if (result == null) result = caseCodeElement(dPackage);
				if (result == null) result = caseIInfoElement(dPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.DCLASS: {
				DClass dClass = (DClass)theEObject;
				T result = caseDClass(dClass);
				if (result == null) result = caseIComponent(dClass);
				if (result == null) result = caseCodeElement(dClass);
				if (result == null) result = caseIInfoElement(dClass);
				if (result == null) result = caseNOMMetric(dClass);
				if (result == null) result = caseNOAMetric(dClass);
				if (result == null) result = caseIStaticsMetric(dClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.DMETHOD: {
				DMethod dMethod = (DMethod)theEObject;
				T result = caseDMethod(dMethod);
				if (result == null) result = caseCodeElement(dMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StaticsPackage.DATTRIBUTE: {
				DAttribute dAttribute = (DAttribute)theEObject;
				T result = caseDAttribute(dAttribute);
				if (result == null) result = caseCodeElement(dAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseDClass(DClass object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMethod</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>DMethod</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDMethod(DMethod object) {
		return null;
	}
