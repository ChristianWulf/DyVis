...
public class StaticsFactoryImpl extends EFactoryImpl implements StaticsFactory {
	...
	public static StaticsFactory init() {
		try {
			StaticsFactory theStaticsFactory = (StaticsFactory)EPackage.Registry.INSTANCE.getEFactory("www.chw-thesis-WS09.de"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case StaticsPackage.PACKAGE: return createPackage();
			case StaticsPackage.CLASS: return createClass();
			case StaticsPackage.ATTRIBUTE: return createAttribute();
			case StaticsPackage.METHOD: return createMethod();
			default:
	 ...
	 * @generated
	 */
	public statics.Package createPackage() {
	 ...
	 * @generated
	 */
	public statics.Class createClass() {
