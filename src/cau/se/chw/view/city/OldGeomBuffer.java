...
public class OldGeomBuffer extends Object {
	...
	int[] currPrimType = null, currPrimStartVertex = null, currPrimEndVertex = null;
	...
	void outVertex(Point3f[] dpts, Vector3f[] dnormals, TexCoord2f[] dtcoords, int dloc,
			Point3f[] spts, Vector3f[] snormals, Point2f[] stcoords, int sloc) {
		if (debug >= 1) {
			System.out.println("v " + spts[sloc].x + " " + spts[sloc].y + " " + spts[sloc].z);
		}
