 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/platform" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/core" xmlns:xs="http://www.w3.org/2001/XMLSchema" abstract="true" name="AbstractPlatformElement">
 *   &lt;xs:complexContent>
...
public abstract class AbstractPlatformElement extends KDMEntity
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://schema.omg.org/spec/KDM/1.2/platform" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/code" xmlns:ns2="http://schema.omg.org/spec/KDM/1.2/action" xmlns:ns3="http://schema.omg.org/spec/KDM/1.2/source" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element type="ns3:SourceRef" name="source"/>
     *   &lt;xs:element type="ns:AbstractPlatformRelationship" name="relation"/>
    ...
    public static class Choice
    {
         ...
         * @return value
         */
        public AbstractPlatformRelationship getRelation() {
            return relation;
        }
         ...
         * @param relation
         */
        public void setRelation(AbstractPlatformRelationship relation) {
