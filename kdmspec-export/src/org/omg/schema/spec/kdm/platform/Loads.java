 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/platform" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="Loads">
 *   &lt;xs:complexContent>
...
public class Loads extends AbstractPlatformRelationship
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://schema.omg.org/spec/KDM/1.2/platform" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/action" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element type="ns:DeployedComponent" name="to"/>
    ...
    public static class Choice
    {
         ...
         * @param to
         */
        public void setTo(DeployedComponent to) {
