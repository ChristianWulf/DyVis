 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/platform" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="Requires">
 *   &lt;xs:complexContent>
...
public class Requires extends AbstractPlatformRelationship
{
     ...
     *   &lt;xs:element type="ns:AbstractPlatformElement" name="to"/>
     *   &lt;xs:element type="ns:DeployedComponent" name="from"/>
     * &lt;/xs:choice>
     * </pre>
     */
    public static class Choice
    {
        ...
        private AbstractPlatformElement to;
        private DeployedComponent from;
         ...
         * @param to
         */
        public void setTo(AbstractPlatformElement to) {
         ...
         * @param from
         */
        public void setFrom(DeployedComponent from) {
