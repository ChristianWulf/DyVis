 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/source" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="InventoryRelationship">
 *   &lt;xs:complexContent>
...
public class InventoryRelationship extends AbstractInventoryRelationship
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://schema.omg.org/spec/KDM/1.2/core" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/source" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element type="ns:KDMEntity" name="to"/>
     *   &lt;xs:element type="ns1:AbstractInventoryElement" name="from"/>
     * &lt;/xs:choice>
     * </pre>
     */
