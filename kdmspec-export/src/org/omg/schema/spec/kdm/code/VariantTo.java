 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/code" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="VariantTo">
 *   &lt;xs:complexContent>
...
public class VariantTo extends AbstractCodeRelationship
{
     ...
     *   &lt;xs:element type="ns:PreprocessorDirective" name="to"/>
     *   &lt;xs:element type="ns:PreprocessorDirective" name="from"/>
     * &lt;/xs:choice>
     * </pre>
     */
    public static class Choice
    {
        ...
        private PreprocessorDirective to;
        private PreprocessorDirective from;
         ...
         * @param to
         */
        public void setTo(PreprocessorDirective to) {
         ...
         * @param from
         */
        public void setFrom(PreprocessorDirective from) {
