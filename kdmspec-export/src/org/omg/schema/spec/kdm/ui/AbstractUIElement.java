 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/core" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/ui" xmlns:xs="http://www.w3.org/2001/XMLSchema" abstract="true" name="AbstractUIElement">
 *   &lt;xs:complexContent>
...
public abstract class AbstractUIElement extends KDMEntity
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://schema.omg.org/spec/KDM/1.2/code" xmlns:ns1="http://schema.omg.org/spec/KDM/1.2/ui" xmlns:ns2="http://schema.omg.org/spec/KDM/1.2/action" xmlns:ns3="http://schema.omg.org/spec/KDM/1.2/source" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element type="ns3:SourceRef" name="source"/>
     *   &lt;xs:element type="ns1:AbstractUIRelationship" name="UIRelation"/>
     *   &lt;xs:element type="ns:AbstractCodeElement" name="implementation"/>
    ...
    public static class Choice
    {
        ...
        private static final int UI_RELATION_CHOICE = 1;
        private static final int IMPLEMENTATION_CHOICE = 2;
        private static final int ABSTRACTION_CHOICE = 3;
        private SourceRef source;
        private AbstractUIRelationship UIRelation;
        ...
        /** 
         * Check if UIRelation is current selection for choice.
         * 
         * @return <code>true</code> if selection, <code>false</code> if not
         */
        public boolean ifUIRelation() {
            return choice2Select == UI_RELATION_CHOICE;
        }

        /** 
         * Get the 'UIRelation' element value.
         * 
         * @return value
         */
        public AbstractUIRelationship getUIRelation() {
            return UIRelation;
        }

        /** 
         * Set the 'UIRelation' element value.
         * 
         * @param UIRelation
         */
        public void setUIRelation(AbstractUIRelationship UIRelation) {
            setChoice2Select(UI_RELATION_CHOICE);
            this.UIRelation = UIRelation;
        }
