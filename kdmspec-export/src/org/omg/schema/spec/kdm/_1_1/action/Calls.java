...
import org.omg.schema.spec.kdm._1_1.code.ControlElement;


/**
 * <p>Java class for Calls complex type.
 * 
 ...
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/code}ControlElement"/>
    ...
    extends AbstractActionRelationship
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "to", type = ControlElement.class)
    })
