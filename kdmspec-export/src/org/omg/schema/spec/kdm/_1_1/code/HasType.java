...
/**
 * <p>Java class for HasType complex type.
 * 
...
@XmlType(name = "HasType", propOrder = {
    "toOrFrom"
})
    ...
    extends AbstractCodeRelationship
{
    ...
    protected List<CodeItem> toOrFrom;
    @XmlAttribute
    protected String to;
    @XmlAttribute
     ...
     * 
     */
    public List<CodeItem> getToOrFrom() {
        if (toOrFrom == null) {
            toOrFrom = new ArrayList<CodeItem>();
        }
