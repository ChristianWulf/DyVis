...
import org.omg.schema.spec.kdm._1_1.code.ComputationalObject;
 ...
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/code}ComputationalObject"/>
    ...
    extends AbstractActionRelationship
{
    ...
    @XmlElements({
        @XmlElement(name = "to", type = ComputationalObject.class),
