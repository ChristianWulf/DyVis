...
/**
 * <p>Java class for PlatformAction complex type.
 * 
 ...
 *         &lt;element name="platformElement" type="{http://schema.omg.org/spec/KDM/1.1/platform}PlatformEvent"/>
 *       &lt;/choice>
...
@XmlType(name = "PlatformAction", propOrder = {
    "platformElement"
})
@XmlSeeAlso({
    ExternalActor.class
    ...
    extends AbstractPlatformElement
{
    ...
    protected List<PlatformEvent> platformElement;
    @XmlAttribute
     ...
     * 
     */
    public List<PlatformEvent> getPlatformElement() {
        if (platformElement == null) {
            platformElement = new ArrayList<PlatformEvent>();
        }
