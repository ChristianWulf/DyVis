...
import org.omg.schema.spec.kdm._1_1.source.Image;


/**
 * <p>Java class for DisplaysImage complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DisplaysImage">
 *   &lt;complexContent>
 *     &lt;extension base="{http://schema.omg.org/spec/KDM/1.1/ui}AbstractUIRelationship">
 *       &lt;choice maxOccurs="unbounded" minOccurs="0">
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/source}Image"/>
...
@XmlType(name = "DisplaysImage", propOrder = {
    "toOrFrom"
})
public class DisplaysImage
    extends AbstractUIRelationship
{

    @XmlElements({
        @XmlElement(name = "from", type = ActionElement.class),
        @XmlElement(name = "to", type = Image.class)
    })
