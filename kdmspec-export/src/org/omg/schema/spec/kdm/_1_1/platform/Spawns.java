...
/**
 * <p>Java class for Spawns complex type.
 * 
 ...
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/platform}RuntimeResource"/>
    ...
    extends AbstractPlatformRelationship
{
    ...
    @XmlElements({
        @XmlElement(name = "to", type = RuntimeResource.class),
