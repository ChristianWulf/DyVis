 ...
 *         &lt;element name="dataElement" type="{http://schema.omg.org/spec/KDM/1.1/data}AbstractDataElement"/>
 *       &lt;/choice>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends KDMModel
{
    ...
    protected List<AbstractDataElement> dataElement;
     ...
     * 
     */
    public List<AbstractDataElement> getDataElement() {
        if (dataElement == null) {
            dataElement = new ArrayList<AbstractDataElement>();
        }
