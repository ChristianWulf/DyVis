...
/**
 * <p>Java class for HasState complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="HasState">
 *   &lt;complexContent>
 *     &lt;extension base="{http://schema.omg.org/spec/KDM/1.1/action}AbstractActionRelationship">
 *       &lt;choice maxOccurs="unbounded" minOccurs="0">
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/event}AbstractEventElement"/>
...
@XmlType(name = "HasState", propOrder = {
    "toOrFrom"
})
    ...
    extends AbstractActionRelationship
{
    ...
    @XmlElements({
        @XmlElement(name = "to", type = AbstractEventElement.class),
