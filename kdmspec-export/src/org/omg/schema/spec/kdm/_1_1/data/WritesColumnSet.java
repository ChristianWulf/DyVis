...
/**
 * <p>Java class for WritesColumnSet complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WritesColumnSet">
 *   &lt;complexContent>
 *     &lt;extension base="{http://schema.omg.org/spec/KDM/1.1/action}AbstractActionRelationship">
 *       &lt;choice maxOccurs="unbounded" minOccurs="0">
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/data}ColumnSet"/>
...
@XmlType(name = "WritesColumnSet", propOrder = {
    "toOrFrom"
})
public class WritesColumnSet
    extends AbstractActionRelationship
{

    @XmlElements({
        @XmlElement(name = "from", type = ActionElement.class),
        @XmlElement(name = "to", type = ColumnSet.class)
    })
