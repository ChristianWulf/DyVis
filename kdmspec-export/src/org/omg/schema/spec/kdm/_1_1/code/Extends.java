 ...
 *         &lt;element name="from" type="{http://schema.omg.org/spec/KDM/1.1/code}Datatype"/>
 *       &lt;/choice>
    ...
    extends AbstractCodeRelationship
{
    ...
    protected List<JAXBElement<Datatype>> toOrFrom;
    @XmlAttribute
    protected String to;
    @XmlAttribute
     ...
     * 
     */
    public List<JAXBElement<Datatype>> getToOrFrom() {
        if (toOrFrom == null) {
            toOrFrom = new ArrayList<JAXBElement<Datatype>>();
        }
