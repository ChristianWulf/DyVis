...
/**
 * <p>Java class for InstanceOf complex type.
 * 
 ...
 *         &lt;element name="to" type="{http://schema.omg.org/spec/KDM/1.1/code}TemplateUnit"/>
...
@XmlType(name = "InstanceOf", propOrder = {
    "toOrFrom"
})
    ...
    extends AbstractCodeRelationship
{
    ...
    @XmlElements({
        @XmlElement(name = "to", type = TemplateUnit.class),
