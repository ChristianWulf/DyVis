 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://schema.omg.org/spec/KDM/1.2/event" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="ConsumesEvent">
 *   &lt;xs:complexContent>
...
public class ConsumesEvent extends AbstractEventRelationship
{
     ...
     * Schema fragment(s) for this class:
     * <pre>
     * &lt;xs:choice xmlns:ns="http://schema.omg.org/spec/KDM/1.2/event" xmlns:xs="http://www.w3.org/2001/XMLSchema" minOccurs="0" maxOccurs="unbounded">
     *   &lt;xs:element type="ns:Event" name="to"/>
     *   &lt;xs:element type="ns:Transition" name="from"/>
     * &lt;/xs:choice>
     * </pre>
     */
